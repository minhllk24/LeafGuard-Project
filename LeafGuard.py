...
class StudentInfoApp:
    ...
    def setup_ui(self):
        # Logo trường
        try:
            logo_image = Image.open("aptech.png")  # Change your logo file path
        ...
        # Phân đoạn chứa các hình ảnh minh họa
        ...
        teacher_label = tk.Label(self.root, text="Techwiz: Big Data in Data Science", font=("Arial", 12), bg='#E0F2F1')  # Đặt màu nền xanh nhạt
        teacher_label.pack(pady=5)
        # Thông tin sinh viên
        students = [
            
            {"Group": "Data Not Found", "Member": "4"}
        ]

        for student in students:
            student_info = tk.Label(self.root, text=f"Group: {student['Group']} - Member: {student['Member']}", font=("Arial", 12), bg='#E0F2F1')  # Đặt màu nền xanh nhạt
    ...
    def open_image(self, path):
        try:
            webbrowser.open(path)  # Mở ảnh bằng chương trình mặc định
